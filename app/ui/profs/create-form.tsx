...
import { createProfNew } from "@/app/lib/actions";
export function Form({ profs }: { profs: Professor[] }) {
  return (
...
//
//
export default function FormNew({ profs }: { profs: ProfessorNew[] }) {
  return (
    <form action={createProfNew}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        <div className="mb-4">
          <label htmlFor="name" className="mb-2 block text-sm font-medium">
            ФИО
